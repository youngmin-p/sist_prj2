...
//		jspOnScreenList.getViewport().setOpaque(false);
		...
		jbtSearch.setFont(new Font("나눔고딕", Font.BOLD, 16));
...
//		jbtSearch.setContentAreaFilled(false);
		...
		jbtBook = new JButton("예매");
		jbtBook.setFont(new Font("나눔고딕", Font.BOLD, 16));
...
//		jbtBook.setContentAreaFilled(false);
		...
		jbtClose.setFont(new Font("나눔고딕", Font.BOLD, 16));
