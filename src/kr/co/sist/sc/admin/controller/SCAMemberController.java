...
public class SCAMemberController extends WindowAdapter implements ActionListener, MouseListener {

	private SCAMemberManageView scammv;

	public SCAMemberController(SCAMemberManageView scammv) {
		this.scammv = scammv;
	...
	public void mousePressed(MouseEvent me) {
		if(me.getSource() == scammv.getJbtMemberSelectAll()) {
			scammv.getJbtMemberSelectAll().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbt_member_select_all_pressed(125x40).png"));
		} // end if
		
		if(me.getSource() == scammv.getJbtMemberSelectOne()) {
			scammv.getJbtMemberSelectOne().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbt_member_select_one_pressed(100x30).png"));
		} // end if
		
		if(me.getSource() == scammv.getJbtClose()) {
			scammv.getJbtClose().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbtClose_pressed(125x40).png"));
		} // end if
	}
	...
	public void mouseReleased(MouseEvent me) {
		if(me.getSource() == scammv.getJbtMemberSelectAll()) {
			scammv.getJbtMemberSelectAll().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbt_member_select_all(125x40).png"));
		} // end if
		
		if(me.getSource() == scammv.getJbtMemberSelectOne()) {
			scammv.getJbtMemberSelectOne().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbt_member_select_one(100x30).png"));
		} // end if
		
		if(me.getSource() == scammv.getJbtClose()) {
			scammv.getJbtClose().setIcon(new ImageIcon("C:/dev/workspace/cinema_prj/src/kr/co/sist/sc/admin/images/jbtClose(125x40).png"));
		} // end if
	}
