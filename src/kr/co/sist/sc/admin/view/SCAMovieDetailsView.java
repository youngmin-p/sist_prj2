...
public class SCAMovieDetailsView extends JDialog {
	...
	public JTextField jtfmovieCode, jtfmovieTitle, jtfGenre, jtfCountry, jtfDirector, jtfmovieGrade, jtfRunningtime,
			jtfPlaydate, jtfActor;
	public JTextArea jtaSysnopsis;
	public JButton delete, exit;

	public SCAMovieDetailsView(SCAMovieManageView scammv, SCAMovieDatailsVO scamd_vo, SCAMovieManageController scammc) {
		super(scammv, " 영화 상세 정보", true);// 모달로 받아야함
		...
		jtaSysnopsis.setBackground(new Color(20, 37, 70));
...
//		jsSysnopsis.setFont(new Font("나눔고딕", Font.BOLD, 16));
		...
		SCAMovieDetailsController scdc = new SCAMovieDetailsController(this, scammc);
